...
## 4. Correlation Matrices, and VIF

We generated our correlation matrices in Python with the file name <i>correlation_matrix.ipynb</i>, we've also ran vif and lasso to test multicollinearity

The VIF values for each of the independent variables
```{r}
vif(fit1)
```
