...
# Drop the first row as it contains an header that is not needed
pov_2020 <- pov2020[-1,] 
...
# Filter for only 5 counties and then rename columns
pov19 <- pov19 %>%
...
### print the first several rows of the data just to verify
